      ...
      <div className="row">
        <div className="row rootborder"><div className="col-xs-12 emenucol-head" style={{ padding: '10px' }}>
          ...
          {!this.state.showGridView &&
            <strong style={{ float: 'right', cursor: 'pointer', textDecoration: 'underline', color: '#3f3fb5' }} onClick={this.onEditClick.bind(this)}>Edit</strong>}
          <div className="App">
        ...
        <button className="btn btn-primary pull-right btn-cus" type="button" onClick={() => { this.refs['grid'].wrappedInstance.submitHandle(); }}>get rates</button>
      </div>
    );
  }
