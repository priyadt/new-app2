      ...
      <div className="">
        <div className="row-fluid product">
          <div className="span3">
            ...
            <p className="r-small-top-margin">
              {((productRateInfo) || (!this.props.optType.isRateable)) ?
                (!this.props.isRatesLoading ?
                (productPackageInfo ?
                  ((productPackageInfo.cost) ?
                    <a className="anchor-pointer" onClick={this.updateShowMore.bind(this)}>
                   ...
                   : 'No rates were returned from provider.') : 'Retrieving Rates...')
                 : 'Retrieving Rates...'}
            </p>
          </div>
        ...
        {((productRateInfo && productRateInfo.length > 0) || (!this.props.optType.isRateable)) && <ExpandedProduct
          key={"Expanded" + this.props.key + this.state.providerId + (this.state.providerCode !==null ? this.state.providerCode : 'NR' ) + this.state.productCode}
